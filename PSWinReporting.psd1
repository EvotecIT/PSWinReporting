...
FunctionsToExport = 'Get-ComputerChanges', 'Get-ComputerStatus', 
               'Get-EventLogClearedLogs', 'Get-GroupCreateDelete', 
               'Get-GroupMembershipChanges', 'Get-GroupPolicyChanges', 
               'Get-LogonEvents', 'Get-LogonEventsKerberos', 'Get-RebootEvents', 
               'Get-UserChanges', 'Get-UserLockouts', 'Get-UserStatuses', 
