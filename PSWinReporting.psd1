...
FunctionsToExport = 'Add-TaskScheduledForwarder', 'Find-ADEvents', 
               'New-SubscriptionTemplates', 'Remove-TaskScheduledForwarder', 
               'Set-SubscriptionTemplates', 'Start-ADReporting', 
               'Start-Notifications', 'Start-SubscriptionService'
