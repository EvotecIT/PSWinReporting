...
@{
    ...
    RequiredModules   = @('PSEventViewer', 'PSWriteColor', 'PSSharedGoods', 'PSWriteExcel')
    ...
    FunctionsToExport = 'Start-ADReporting', 'Start-Notifications', 'New-SubscriptionTemplates', 'Set-SubscriptionTemplates', 'Remove-TaskScheduledForwarder', 'Add-TaskScheduledForwarder', 'Start-SubscriptionService', 'Start-RescanEvents'
    #FunctionsToExport = '*'
