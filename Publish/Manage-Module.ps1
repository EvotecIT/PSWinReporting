    ...
    Information = @{
        ...
        Manifest          = @{
            ...
            RequiredModules = @(
                ...
                @{ ModuleName = 'PSSharedGoods'; ModuleVersion = "0.0.77"; Guid = 'ee272aa8-baaa-4edf-9f45-b6d6f7d844fe' }
                @{ ModuleName = 'PSWriteExcel'; ModuleVersion = "0.1.1"; Guid = '82232c6a-27f1-435d-a496-929f7221334b' }
                @{ ModuleName = 'PSWriteHTML'; ModuleVersion = '0.0.34'; Guid = 'a7bdf640-f5cb-4acf-9de0-365b322d245c' }
            )
        }
    }
    Options     = @{
